  ...
  render() {
    return (
     ...
     />
        ...
        <View style={{paddingHorizontal:width*0.03,paddingTop:width*0.7,justifyContent:'center',alignItems:'center'}}>
<Text style={{fontSize:width*0.04,color:'#000000aa',fontFamily:"Poppins-SemiBold",fontWeight:'500'}}>
    No Notification allow for this  yet.
</Text>
        </View>
        </SafeAreaView>
    )
