...
export default class UnderstandQuran extends Component {
  render() {
    return (
      <View style={{width: '100%',height: '100%'}}>
      <View style={{width: '100%',height: '10%', backgroundColor: '#fdfdfd',paddingHorizontal:width*0.06,
      alignItems:'center',justifyContent:'space-between',flexDirection:'row'}}>
    <Text style={{paddingHorizontal:1,fontSize:width*0.06,fontWeight:'bold'}}>Understand Qur’an: Ongoing Batches</Text>
    </View>
