import { Text, View ,Dimensions,StyleSheet,ScrollView,TextInput,TouchableOpacity} from 'react-native'
import React, { Component } from 'react'
const { width, height } = Dimensions.get("window");
import DropDownPicker from 'react-native-dropdown-picker';

export default class AddNextClass extends Component {
    constructor(props) {
        super(props);
        this.state = {
          initializing: true,
      ...
      {label: ' Level-1 English ', value: ' Level-1 English '}
        ...
        return (
         ...
         <Text style={{paddingHorizontal:12,fontSize:width*0.06,fontWeight:'bold'}}>Add Next Class Preparation</Text>
       </View>
       <View style={styles.Container}>
         <Text style={{fontSize:width*0.05,fontWeight:"bold",paddingVertical:width*0.06}}>
           ADD NEXT CLASS PREPARATION
         </Text>
