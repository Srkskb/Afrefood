...
export default class Preparation extends Component {
  render() {
    return (
     ...
     <Text style={{paddingHorizontal:12,fontSize:width*0.06,fontWeight:'bold'}}>Next Class</Text>
     <TouchableOpacity onPress={()=>this.props.navigation.navigate('AddNextClass')}>
