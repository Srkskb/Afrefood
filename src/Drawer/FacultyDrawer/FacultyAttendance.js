...
export default class FacultyAttendance extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
     ...
     <Text style={{paddingHorizontal:12,fontSize:width*0.06,fontWeight:'bold'}}>Student Attendance Report</Text>
   </View>
   <View style={{
     height:700,
