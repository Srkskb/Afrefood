...
export default class EditBatch extends Component {
  render() {
    return (
     ...
     <Text style={{paddingHorizontal:12,fontSize:width*0.06,fontWeight:'bold'}}>Batch</Text>
     <TouchableOpacity onPress={()=>this.props.navigation.navigate('Batch')}>
       ...
       paddingHorizontal:width*0.06,paddingVertical:width*0.02,color:'#727cf5',borderColor:'#727cf5'}}>
         +Add Batch
       </Text>
     </TouchableOpacity>
   </View>
   <View style={{width: '100%',height: '10%', backgroundColor: '#fdfdfk',paddingHorizontal:width*0.06,
     ...
     <Text style={{paddingHorizontal:12,fontSize:width*0.05,fontWeight:'bold'}}>Batch</Text>
   </View>
