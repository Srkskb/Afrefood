...
export default class Follow extends Component {
  ...
  render() {
    ...
    return (
     ...
     <Text style={{paddingHorizontal:12,fontSize:width*0.06,fontWeight:'bold'}}>Follow Up with Non Serious Students</Text>
   </View>
   <View style={{justifyContent:'flex-start',backgroundColor:"#ffffff"}}>
     <Text style={{fontSize:width*0.05,fontWeight:"bold",paddingHorizontal:width*0.06,paddingTop:width*0.02}}>
     Class Not Attended
     </Text>
   </View>
   <View style={{
